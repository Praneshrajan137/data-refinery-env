...
lint:
	$(PYTHON) -m ruff check dataforge tests scripts/bench scripts/ci scripts/perf scripts/playground scripts/data scripts/model scripts/preflight scripts/remote scripts/publish_model.py scripts/measure_payload_split.py scripts/measure_trust_ledger.py playground/api/app.py
	$(PYTHON) -m ruff format --check dataforge tests scripts/bench scripts/ci scripts/perf scripts/playground scripts/data scripts/model scripts/preflight scripts/remote scripts/publish_model.py scripts/measure_payload_split.py playground/api/app.py
	$(PYTHON) scripts/ci/generate_domain_vocabulary.py --check
	$(PYTHON) scripts/ci/generate_attestation_vectors.py --check
	$(PYTHON) scripts/ci/generate_attestation_schema.py --check
	$(PYTHON) scripts/ci/test_map_coverage.py --check

format:
	$(PYTHON) -m ruff format dataforge tests scripts/bench scripts/ci scripts/perf scripts/playground scripts/data scripts/model scripts/preflight scripts/remote scripts/publish_model.py scripts/measure_payload_split.py playground/api/app.py
	$(PYTHON) -m ruff check --fix dataforge tests scripts/bench scripts/ci scripts/perf scripts/playground scripts/data scripts/model scripts/preflight scripts/remote scripts/publish_model.py scripts/measure_payload_split.py playground/api/app.py
