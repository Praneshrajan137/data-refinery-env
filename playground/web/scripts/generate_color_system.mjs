...
const seeds = {
  neutral: { l: 0.64, c: 0.012, h: 255, meaning: "graphite-platinum product structure" },
  brand: { l: 0.56, c: 0.105, h: 250, meaning: "sovereign blue command signal" },
  data: { l: 0.58, c: 0.052, h: 218, meaning: "forensic steel evidence" },
  agent: { l: 0.55, c: 0.058, h: 286, meaning: "restrained amethyst orchestration" },
  success: { l: 0.56, c: 0.034, h: 155, meaning: "proof verdigris verification" },
  warning: { l: 0.68, c: 0.065, h: 82, meaning: "antique amber uncertainty" },
  danger: { l: 0.55, c: 0.078, h: 28, meaning: "oxide red risk" },
};
