...
const semanticRefs = {
  light: {
    ...
    "--df-proven-bg": "neutral-100",
    "--df-proven-text": "success-30",
    "--df-proven-line": "success-60",
    "--df-plausibility-bg": "neutral-100",
    "--df-plausibility-text": "agent-30",
    "--df-plausibility-line": "agent-60",
  ...
  dark: {
    ...
    "--df-proof-line": "data-60",
    "--df-proven-bg": "neutral-20",
    "--df-proven-text": "success-90",
    "--df-proven-line": "success-60",
    "--df-plausibility-bg": "neutral-20",
    "--df-plausibility-text": "agent-90",
    "--df-plausibility-line": "agent-60",
