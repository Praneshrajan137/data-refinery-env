...
if _EnvClient is not None:
    ...
    class DataQualityEnv(
        ...
        def _parse_result(self, payload: Dict[str, Any]) -> _StepResult:  # type: ignore[type-var]
        ...
        def _parse_state(self, payload: Dict[str, Any]) -> DataQualityState:
    ...
    class DataQualityEnv:  # type: ignore[no-redef]
        ...
        def __enter__(self) -> DataQualityEnv:
            ...
            logger.info("Connected to %s via %s", self.ws_url, self._transport_name)
            return self
